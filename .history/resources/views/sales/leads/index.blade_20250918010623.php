...
<div class="container mx-auto py-6">
  ...
  <!-- Tombol lebih besar (tap-friendly), kontras, dan adaptif tema -->
  <label tabindex="0" role="button"
    ...
    Opsi
    <!-- indikator -->
    <svg class="h-3 w-3 opacity-60 -mr-1" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M7 14l5-5 5 5"></path>
    </svg>
  </label>

  <!-- Menu: kecil, z-index tinggi, warna mengikuti tema, dan muncul ke atas -->
  <ul tabindex="0"
      class="dropdown-content menu menu-sm p-2 shadow-2xl bg-base-100 text-base-content
             rounded-xl w-56 z-50 border border-base-300/60">
    <li>
      <a href="#import_modal">
        <svg class="h-4 w-4 opacity-70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <li>
      <a href="{{ route('lead-follow-up-rules.index') }}">
        <svg class="h-4 w-4 opacity-70" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div class="card shadow-lg border border-base-300/50 {{ $g['bg'] }}" data-aos="fade-up" data-aos-delay="{{ $g['delay'] }}">
            <div class="card-body p-0">
                ...
                <div class="overflow-x-auto overflow-y-visible">
                    {{-- TABLE ADAPTIF: zebra + thead base-200 agar otomatis mengikuti tema DaisyUI --}}
                            ...
                            <tr id="lead-row-{{ $lead->id }}" class="hover"
                                ...
                                <td class="text-center">
                                    <div class="dropdown dropdown-end">
                                        ...
                                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-44 z-10 border border-base-300/50">
                                            @if($lead->phone)
...
@push('modals')
    ...
    <div id="create_lead_modal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box w-11/12 max-w-2xl max-h-[80vh] overflow-y-auto">
