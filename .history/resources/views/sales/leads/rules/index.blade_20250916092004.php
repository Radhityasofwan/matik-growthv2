            ...
            <table class="table table-zebra w-full">
                ...
                <tbody>
                    ...
                    <tr>
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="avatar">
                                        <div class="w-8 rounded-full">
                                            <img src="{{ $rule->lead->owner?->avatar_url ?? 'https://ui-avatars.com/api/?name='.urlencode($rule->lead->name ?? 'Lead') }}" alt="PIC">
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <td>
                            <span class="badge">
                                {{ $labels[$rule->condition] ?? $rule->condition }}
                            </span>
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <div class="flex items-center gap-2 justify-center">
                                ...
                                <form method="POST" action="{{ route('lead-follow-up-rules.destroy', $rule) }}"
                    ...
                    @empty
                    <tr>
                        <td colspan="8" class="text-center text-gray-500 py-8">Belum ada aturan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
