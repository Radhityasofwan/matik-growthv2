...
<div class="container mx-auto py-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        @foreach($groups as $g)
        {{-- SINKRONISASI: Menggunakan struktur 'card' dan menerapkan background dinamis --}}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Menggunakan selector berbasis class untuk menghindari error sintaks dari perulangan PHP
