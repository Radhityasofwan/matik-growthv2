...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            ...
            <a href="{{ route('lead-follow-up-rules.index') }}" class="btn btn-outline btn-info btn-sm">Atur Reminder</a>
                    ...
                    <tbody>
                        ...
                        <tr id="lead-row-{{ $lead->id }}"
                            ...
                            <td class="font-medium">
                                <a href="{{ route('leads.show', $lead) }}" class="link link-primary">
                                    {{ $lead->name ?? '-' }}
                                </a>
                            </td>
                            <td>{{ $lead->phone ?? '-' }}</td>
                            ...
                            <td><span class="badge badge-ghost">{{ $lead->chat_count }}</span></td>
