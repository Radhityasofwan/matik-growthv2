                    ...
                    <tbody class="bg-white dark:bg-gray-800">
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 text-sm text-right">
                                {{-- MODIFIED: This link now opens the edit modal for the specific lead --}}
    ...
    <div class="modal-box w-11/12 max-w-2xl dark:bg-gray-800">
        <form action="{{ route('leads.store') }}" method="POST">
            ...
            <div class="mt-4 space-y-4">
                <!-- Name -->
                <div>
                    <label class="label" for="name_create">
                        <span class="label-text dark:text-gray-300">Name</span>
                    </label>
                    <input type="text" id="name_create" name="name" placeholder="Enter full name" class="input input-bordered w-full dark:bg-gray-700 dark:text-gray-200" required />
                </div>
                <!-- Email -->
                <div>
                    ...
                    <input type="email" id="email_create" name="email" placeholder="Enter email address" class="input input-bordered w-full dark:bg-gray-700 dark:text-gray-200" required />
                </div>
                <!-- Status -->
                <div>
                    <label class="label" for="status_create">
                ...
                <!-- Owner -->
                <div>
                    <label class="label" for="owner_id_create">
...
<!-- ADDED: Edit Lead Modals (inside the loop) -->
    ...
    <div class="modal-box w-11/12 max-w-2xl dark:bg-gray-800">
        <form action="{{ route('leads.update', $lead) }}" method="POST">
            ...
            <div class="mt-4 space-y-4">
                <!-- Name -->
                <div>
                    <label class="label" for="name_edit_{{ $lead->id }}">
                        <span class="label-text dark:text-gray-300">Name</span>
                    </label>
                ...
                <!-- Email -->
                <div>
                    <label class="label" for="email_edit_{{ $lead->id }}">
                        <span class="label-text dark:text-gray-300">Email Address</span>
                    </label>
                ...
                <!-- Status -->
                <div>
                    <label class="label" for="status_edit_{{ $lead->id }}">
                        <span class="label-text dark:text-gray-300">Status</span>
                    </label>
                ...
                <!-- Owner -->
                <div>
                    <label class="label" for="owner_id_edit_{{ $lead->id }}">
                        <span class="label-text dark:text-gray-300">Owner</span>
                    </label>
