...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            {{-- FIX: Menggunakan sintaks object ->trial --}}
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            {{-- FIX: Menggunakan sintaks object ->active --}}
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            {{-- FIX: Menggunakan sintaks object ->converted_rate --}}
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            {{-- FIX: Menggunakan sintaks object ->churn_rate --}}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
        <!-- Leads Growth Chart -->
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md" data-aos="fade-up" data-aos-delay="200">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (canvas) {
            const ctx = canvas.getContext('2d'); // FIX: Changed 'd' to '2d'
