...
@section('content')
@php
    // FIXED: Mengimpor Str facade untuk digunakan di dalam view.
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
    ...
    <div class="card bg-base-100 shadow-lg border border-base-300/50 lg:col-span-2" data-aos="fade-up">
        <div class="card-body">
            ...
            <div x-data="mainChart" x-init="init()" class="w-full h-80 min-h-[320px]">
    ...
    <div class="card bg-base-100 shadow-lg border border-base-300/50" data-aos="fade-up" data-aos-delay="100">
        <div class="card-body">
            ...
            <div x-data="statusDonut" x-init="init()" class="w-full h-80 min-h-[320px] flex items-center justify-center">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
    ...
    <div class="card bg-base-100 shadow-lg border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
            ...
            {{-- FIXED: Menggunakan collect() untuk guard yang lebih aman --}}
    ...
    <div class="card bg-base-100 shadow-lg border border-base-300/50" data-aos="fade-up" data-aos-delay="100">
        <div class="card-body">
            ...
            {{-- FIXED: Menyederhanakan dan mengamankan guard --}}
                ...
                <div class="flex items-start gap-4">
                    <div class="avatar placeholder">
                        <div class="bg-secondary text-secondary-content rounded-full w-10 h-10 flex items-center justify-center">
                            {{-- Penggunaan Str::$method() sekarang aman karena sudah diimpor --}}
...
{{-- Menyimpan data JSON di dalam tag script khusus untuk menghindari error parsing HTML --}}
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('mainChart', () => ({
        ...
        init() {
            let chartData;
            try {
                // Membaca data dari textContent tag script khusus
                chartData = JSON.parse(document.getElementById('dashboard-chart-data').textContent);
            } catch (e) {
                console.error('Gagal mem-parsing data chart utama:', e);
                chartData = {};
            }

            // Render chart setelah memastikan ApexCharts tersedia
            const render = () => {
            ...
            if (window.ApexCharts) {
                ...
                // Fallback jika ApexCharts dari CDN lambat dimuat
                document.addEventListener('DOMContentLoaded', render);
            }

            // Observer untuk perubahan tema tetap dipertahankan
            const observer = new MutationObserver(() => this.renderChart(chartData));
    ...
    Alpine.data('statusDonut', () => ({
        ...
        init() {
            ...
            try {
                // Membaca data dari textContent tag script khusus
                donutData = JSON.parse(document.getElementById('dashboard-status-donut').textContent);
            } catch(e) {
                console.error('Gagal mem-parsing data donut:', e);
                donutData = {};
            }
