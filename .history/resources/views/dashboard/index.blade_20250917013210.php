...
@push('scripts')
{{-- FIXED: Memuat ApexCharts dari CDN untuk memastikan library tersedia secara global --}}
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('mainChart', (chartData) => ({
        ...
        init() {
            ...
            // FIXED: Gunakan MutationObserver untuk mendeteksi perubahan tema secara otomatis
