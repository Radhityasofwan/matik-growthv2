...
@push('scripts')
{{-- FIXED: Menghapus atribut 'defer' untuk memastikan script ini dimuat sebelum Alpine --}}
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('mainChart', () => ({
        ...
        init() {
            ...
            // FIXED: Hapus loop 'checkApex', langsung render karena script sudah blocking
            setTimeout(() => {
                this.isLoading = false;
                this.$nextTick(() => this.renderChart(chartData));
            }, 300); // Penundaan singkat untuk estetika
    ...
    Alpine.data('statusDonut', () => ({
        ...
        init() {
            ...
            // FIXED: Hapus loop 'checkApex', langsung render
            setTimeout(() => {
                this.isLoading = false;
