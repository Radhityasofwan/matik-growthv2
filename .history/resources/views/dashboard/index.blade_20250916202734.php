            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body p-5">
                    <div class="flex items-center justify-between">
                        <h2 class="text-sm font-semibold text-neutral/60">{{ $stat['label'] }}</h2>
                    ...
                    <p class="text-3xl font-bold text-neutral mt-2">{{ $stat['value'] }}</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 card bg-base-100 shadow">
                <div class="card-body">
                    ...
                    {{-- PERBAIKAN DI SINI: Menggunakan @json dan single quote --}}
                    <div x-data='mainChart(@json($chartData))' x-init="initChart()" class="w-full h-80">
            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    <h2 class="card-title">Status Leads</h2>
                     {{-- PERBAIKAN DI SINI: Menggunakan @json dan single quote --}}
                    <div x-data='statusDonut(@json($statusCounts))' x-init="initDonut()" class="w-full h-80">
