...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
    ...
    <div class="card bg-base-100 shadow-lg border border-base-300/50 lg:col-span-2" data-aos="fade-up">
        <div class="card-body">
            ...
            {{-- FIXED: Hapus data attribute dari sini --}}
...
{{-- FIXED: Mendefinisikan data chart sebagai variabel JS global --}}
<script>
    window.dashboardChartData = @json($chartData);
    window.dashboardStatusDonut = @json($statusDonut);
</script>
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('mainChart', () => ({
        ...
        chart: null,
        init() {
            // FIXED: Ambil data dari variabel global, bukan dari atribut
    ...
    Alpine.data('statusDonut', () => ({
        ...
        chart: null,
        init() {
            // FIXED: Ambil data dari variabel global
            const donutData = window.dashboardStatusDonut || {};
