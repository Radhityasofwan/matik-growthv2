...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
    ...
    <div class="card bg-base-100 shadow-lg border border-base-300/50" data-aos="fade-up" data-aos-delay="100">
        <div class="card-body">
            ...
            <div x-data="statusDonut(@json($statusDonut))" x-init="init()" class="w-full h-80 min-h-[320px] flex items-center justify-center">
...
@push('scripts')
{{-- Asumsi ApexCharts sudah diimpor global via app.js --}}
<script>
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('mainChart', (chartData) => ({
        ...
        init() {
            ...
            // Tambahkan listener untuk merender ulang chart saat tema berganti
            window.addEventListener('theme-changed', () => this.renderChart(chartData));
        },
        renderChart(data) {
            const el = this.$el.querySelector("#main-chart");
            if (!el) return;
            if (this.chart) this.chart.destroy(); // Hancurkan chart lama sebelum render baru
    ...
    Alpine.data('statusDonut', (donutData) => ({
        ...
        init() {
            setTimeout(() => {
             ...
             window.addEventListener('theme-changed', () => this.renderChart(donutData));
        },
        renderChart(data) {
...
// Dispatch custom event saat theme diubah dari navbar/layout
// Ini perlu ditambahkan di file layout (app.blade.php) di dalam fungsi setTheme
