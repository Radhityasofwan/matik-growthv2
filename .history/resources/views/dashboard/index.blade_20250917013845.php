...
@push('scripts')
{{-- FIXED: Re-adding CDN script to ensure ApexCharts is globally available for inline scripts --}}
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('mainChart', () => ({
        ...
        init() {
            let chartData;
            try {
                // Safely parse data from the data attribute
            ...
            if (typeof ApexCharts === 'undefined') {
                console.error('ApexCharts library is not loaded. Ensure it is included before this script.');
                this.isLoading = false;
                return;
            }
            ...
            // Use MutationObserver to automatically re-render the chart on theme change
