...
<body
  ...
  x-data="{
    ...
    get greet(){ const h=new Date().getHours(); if (h>=5&&h<11) return 'Selamat pagi'; if (h>=11&&h<15) return 'Selamat siang'; if (h>=15&&h<18) return 'Selamat sore'; return 'Selamat malam'; }
  }"
...
>
  <div class="flex min-h-screen">
    ...
    {{-- CONTENT: default ml-20 (collapsed), melebar ke ml-64 saat hover (desktop) --}}
    <div
