...
<body
  ...
  x-data="{
    ...
    isSidebarHover:false,     // desktop hover expand
    isSearchOpen:false,       // <-- DITAMBAHKAN

    get greet(){ const h=new Date().getHours();
...
>
  <div class="flex min-h-screen">
    ...
    {{-- Konten: ml-20 saat collapsed, ml-64 saat hover (desktop) --}}
    <div
      class="flex flex-1 flex-col transition-all duration-300 ease-in-out"
      :class="{
        'lg:ml-20': !isSidebarHover,
        'lg:ml-64':  isSidebarHover
      }"
    >
