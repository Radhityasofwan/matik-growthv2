{{-- resources/views/layouts/app.blade.php — FINAL (DaisyUI defaults) --}}
<!DOCTYPE html>
...
<head>
  ...
  {{-- Pre-apply theme to avoid FOUC (use DaisyUI default themes only) --}}
  <script>
    (function () {
...
<body
  ...
  x-data="{
    // DaisyUI built-in themes only (no custom)
  ...
  <div class="flex min-h-screen">
    ...
    >
      ...
      <main id="main-content" class="flex-1 overflow-x-hidden overflow-y-auto p-4 sm:p-6 lg:p-8">
        {{-- biarkan konten mewarisi token tema: gunakan bg-base-* jika butuh kontras lokal --}}
  ...
  >
    <div class="modal-box bg-base-100">
      ...
      <div class="mt-3 text-xs text-base-content/60">
        Tekan <kbd class="kbd kbd-xs">Esc</kbd> untuk menutup • Pintasan <kbd class="kbd kbd-xs">⌘</kbd>/<kbd class="kbd kbd-xs">Ctrl</kbd>+<kbd class="kbd kbd-xs">K</kbd>
      </div>
    </div>
