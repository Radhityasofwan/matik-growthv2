...
<head>
  ...
  {{-- Script ini mencegah 'flash' tema yang salah saat halaman dimuat ulang --}}
  <script>
    (function(){
...
>
  ...
  <div class="flex min-h-screen">
    {{-- Spacer agar konten tidak tertutup oleh sidebar di desktop --}}
    <div class="hidden lg:block transition-all duration-300" :class="$store.ui.sidebarHover ? 'w-64' : 'w-20'"></div>
  ...
  >
    <div class="modal-box bg-base-100">
      ...
      <label class="input input-bordered flex items-center gap-2">
        <svg xmlns="http://www.w.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4 opacity-70"><path fill-rule="evenodd" d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clip-rule="evenodd"/></svg>
        <input
          x-ref="searchInput"
          type="text"
