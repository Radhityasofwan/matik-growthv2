...
>
  ...
  <body
    ...
    x-data="{
      // STATE UI
      isSidebarExpanded: false,          // desktop: dikontrol hover, bukan toggle
      isMobileMenuOpen: false,           // mobile: dikontrol tombol di navbar
      isSearchOpen: false,

      toggleSidebar(){ /* kept for future use if needed */ },
    ...
    x-init="
      ...
      window.addEventListener('resize', () => { if (window.innerWidth >= 1024) isMobileMenuOpen = false })
    "
  ...
  >
    <div class="flex min-h-screen">
      ...
      <div class="flex flex-1 flex-col transition-all duration-300 ease-in-out lg:ml-20 lg:group-hover/sidebar:ml-64">
