...
<head>
    ...
    <!-- Vite (PERBAIKAN FINAL & STABIL) -->
    {{-- Secara eksplisit memanggil kedua entri CSS dan JS adalah
         cara yang paling robust dan direkomendasikan untuk memastikan
         semua aset dimuat dengan benar oleh Laravel Vite Plugin. --}}
