...
<head>
    ...
    {{-- Tema aktif sejak first paint (anti-FOUC warna) --}}
    <script>
      (function(){
...
<body
    ...
    x-init="init()"
>
    <a href="#main-content" class="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 btn btn-primary btn-sm z-50">Skip to content</a>
    ...
    <div class="flex min-h-screen">
        ...
        >
            <div x-data @sidebar:toggle.window="toggleSidebar()" @mobilemenu:open.window="openMobileMenu()" @mobilemenu:close.window="closeMobileMenu()">
