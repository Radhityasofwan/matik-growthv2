...
628123456789 | Budi" required>{{ old('recipients') }}</textarea>
                        ...
                        <div id="boxTemplate" class="mt-5 hidden">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Variabel mengikuti yang terdeteksi di Template.</p>
                        </div>
...
{{-- ========= JS: diblokir dari Blade dengan @verbatim agar {{ }} tidak di-parse ========= --}}
@verbatim
<script>
(function(){
  ...
  function renderPreview(){
    ...
    if (modeCustom.checked) {
      ...
      list.forEach(r=>{
        ...
        // preview sederhana untuk token umum
