...
628123456789 | Budi" required>{{ old('recipients') }}</textarea>
                        ...
                        <div class="mt-5" x-show="form.mode === 'custom'">
                            ...
                            <textarea name="message" class="textarea textarea-bordered w-full h-36" placeholder="Tulis pesan. Gunakan {{'{{name}}'}} untuk menyapa penerima." x-model="form.message" :required="form.mode==='custom'"></textarea>
                        </div>
