...
@php
    ...
    // Ambil daftar sender aman (hindari select kolom yang belum ada)
                ...
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        ...
                        <div class="space-x-2">
                            ...
                            {{-- tombol refresh stabil: teks selalu ada, spinner hanya saat loading --}}
                            <button type="button"
...
{{-- Script inline (tanpa @push) agar pasti dieksekusi --}}
<script>
