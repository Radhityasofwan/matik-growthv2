...
@php
    ...
    // Deteksi error form (agar modal auto-open)
            ...
            <table class="min-w-full leading-normal">
                ...
                <tbody class="bg-white dark:bg-gray-800">
                    @forelse ($templates as $template)
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 text-sm text-right">
                                <div class="flex items-center gap-3 justify-end">
                                    ...
                                    {{-- Delete (pakai ID eksplisit) --}}
                                    <form action="{{ route('whatsapp.templates.destroy', ['template' => $template->id]) }}"
                        ...
                        <div class="modal">
                            <div class="modal-box w-11/12 max-w-2xl">
                                <form action="{{ route('whatsapp.templates.update', ['template' => $template->id]) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500 mt-2">
                                                Variabel terdeteksi:
                                                @php $nv = $template->normalizedVariables(); @endphp
                                                @if (!empty($nv))
                                                    @foreach ($nv as $v)
