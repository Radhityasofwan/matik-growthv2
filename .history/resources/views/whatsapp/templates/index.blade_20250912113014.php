...
@php
    ...
    function ctx_get($ctx, $key) {
        ...
        // coba juga versi kebalik (underscore -> dash) jika diperlukan
        ...
        foreach ($candidates as $cand) {
            ...
            foreach ($segments as $seg) {
                ...
                // coba underscore/dash alternatif
     ...
     * - Cocok langsung (exact) dengan dot-notation.
     * - Sinonim pintar untuk key umum: name/email/phone/date/today/now.
     * - Fallback: <var> agar jelas mana yang belum terpetakan.
     */
    function resolveVar($key, $ctx) {
        // 1) coba exact dot-notation (dengan variasi -/_)
        $val = ctx_get($ctx, $key);
    ...
    // Tambahkan sinonim populer yang tidak selalu ada di context
