...
<head>
    ...
    <!-- Alpine untuk interaksi ringan (modal preview) -->
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 dark:bg-gray-900">
            <div class="container mx-auto px-6 py-8">
                ...
                <!-- Flash success as toast-like banner -->
                @if (session('success'))
...
>
    <div class="w-full max-w-lg rounded-xl bg-white dark:bg-gray-800 shadow-xl overflow-hidden">
        ...
        <div class="p-5">
            <!-- Simulasi bubble chat WhatsApp sederhana -->
            <div class="space-y-2">
            ...
            <p class="mt-4 text-xs text-gray-500 dark:text-gray-400">
                Variables (e.g., <code>{{'{{name}}'}}</code>) akan digantikan saat pengiriman pesan.
            </p>
        </div>
