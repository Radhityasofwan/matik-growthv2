...
<header class="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
    <div class="flex items-center justify-between h-full px-6">
        <!-- Sidebar Toggle -->
        <button @click="sidebarOpen = !sidebarOpen" class="p-2 rounded-full text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="dropdown dropdown-end">
                <label tabindex="0" class="btn btn-ghost btn-circle avatar">
                    <div class="w-9 rounded-full ring-2 ring-offset-2 ring-offset-base-100 ring-blue-500">
