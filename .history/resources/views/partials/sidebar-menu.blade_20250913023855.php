@php
    $menu = [
        ...
        [
            ...
            'pattern' => 'waha-senders.*',
            'icon'    => '<svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h2l2 3h6l2-3h2a2 2 0 012 2v11a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm6 6h6"/></svg>',
        ],
        [
            'label'   => 'WA Broadcast',
            'route'   => 'whatsapp.broadcast.create',
            'pattern' => 'whatsapp.broadcast.*',
        ...
        [
            ...
            'pattern' => 'whatsapp.logs.*',
            'icon'    => '<svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3M5 11h14M5 19h14M7 15h10"/></svg>',
        ],
    ];

    // dipakai untuk menyembunyikan label saat sidebar collapsed di desktop
