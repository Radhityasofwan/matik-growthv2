...
<div class="sticky top-0 z-30 p-4 pb-0 sm:p-6 sm:pb-0">
  ...
  >
    ...
    <div class="navbar-end gap-1">
      ...
      <div class="dropdown dropdown-end">
        ...
        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-56 z-20 border border-base-300/50">
          ...
          <li><a href="{{ route('assets.index') }}">Assets</a></li> {{-- FIX: assets.index --}}
          <div class="divider my-1"></div>
          <li><a href="{{ route('notifications.index') }}">Semua Notifikasi</a></li>
        </ul>
      </div>

      {{-- THEME SWITCHER — compact preview grid + search (pakai themes, theme, setTheme dari <html x-data>) --}}
      <div
      ...
      {{-- Notifikasi (pakai notifBell jika ada; jika tidak, fallback inline) --}}
      <div
        class="dropdown dropdown-end"
    ...
    {{-- SEARCH MODAL (fixed: gunakan showModal()/close() via x-ref) --}}
<dialog
  x-ref="searchModal"
