<header class="flex-shrink-0 flex items-center justify-between px-6 py-3 bg-white dark:bg-gray-800 border-b dark:border-gray-700">
    ...
    <div class="flex items-center" x-data="{ profileOpen: false, notifOpen: false }">
        <!-- Notifications Dropdown -->
        <div class="relative" x-data="notifications()">
            <button @click="notifOpen = !notifOpen; fetchNotifications()" class="relative text-gray-600 dark:text-gray-300 hover:text-gray-700 focus:outline-none">
