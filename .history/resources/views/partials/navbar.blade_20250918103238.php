<div class="sticky top-0 z-20 px-4 pt-4 sm:px-6 sm:pt-6">
  <header data-aos="fade-down" class="navbar rounded-box border border-base-300/20 bg-base-100/80 shadow md:shadow-md backdrop-blur" role="banner">
