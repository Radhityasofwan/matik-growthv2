...
<header
    ...
    data-preview='@js($previewInit)' {{-- aman: @js menghasilkan JS-safe string --}}
...
{{-- Inline script: tidak bergantung urutan load Vite/Alpine --}}
<script>
function notifBell(el) {
    ...
    return {
        ...
        feedUrl()    { return '/notifications/feed'; },
        readUrl(id)  { return `/notifications/${encodeURIComponent(id)}/read`; },
        markAllUrl() { return '/notifications/read-all'; },
