...
>
  ...
  <nav class="flex-1 overflow-y-auto">
    ...
    {{-- FIXED: Menggunakan [--p] untuk warna menu aktif --}}
    <ul class="menu p-4 space-y-1 [--p:hsl(var(--p))]">
      @foreach ($navGroups as $group => $links)
        {{-- FIXED: Menggunakan kelas 'menu-title' untuk warna yang konsisten --}}
  ...
  <div class="p-4 border-t border-base-300/50">
    <button
      type="button"
      @click="isSidebarExpanded = !isSidebarExpanded; localStorage.setItem('sidebarExpanded', isSidebarExpanded)"
