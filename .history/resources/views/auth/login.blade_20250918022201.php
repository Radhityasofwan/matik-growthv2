...
<head>
    ...
    <style>
        body { 
            ...
            background-image: url("/storage/images/bg-login.webp");
...
<body>
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div class="flex flex-col items-center justify-center mb-8 text-white drop-shadow-lg">
            <img src="{{ asset('storage/images/logo-blue (1).png') }}" alt="Matik Logo" class="h-20 w-auto">
            <span class="text-4xl font-extrabold tracking-tight mt-2">growth up</span>
        </div>

        <!-- Glassmorphism Card -->
        <div class="w-full max-w-md p-8 space-y-6 bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20">
            <div>
            ...
            <form class="space-y-6" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-control">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email" placeholder="your@email.com" class="input input-bordered w-full pl-10 bg-base-100/10" required value="{{ old('email') }}" />
                    </div>
                </div>
                ...
                <div class="form-control">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" placeholder="••••••••" class="input input-bordered w-full pl-10 bg-base-100/10" required />
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    <a href="#" class="font-medium text-primary hover:text-primary-focus">Forgot Password?</a>
                </div>

                <!-- Submit Button -->
                <div class="form-control pt-4">
                    <button type="submit" class="btn btn-primary w-full border-0 bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-700 hover:to-fuchsia-700">Sign in</button>
                </div>
            </form>

            <div class="text-center text-sm text-gray-400">
                {{-- Ganti '#' dengan route('register') jika ada --}}
                Don't have an account? <a href="#" class="font-medium text-primary hover:text-primary-focus">Sign up</a>
            </div>
        </div>
    </div>
</body>
