...
<head>
    ...
    <title>Login - Matik Growth</title>
    ...
    <style>
        body { 
            ...
            /* NOTE: Pastikan gambar Anda ('background.jpg') ada di `storage/public/images` 
...
<body>
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div class="flex flex-col items-center justify-center mb-8 text-white drop-shadow-lg">
            ...
            <span class="text-4xl font-extrabold tracking-tight mt-2">growth</span>
        </div>
