            ...
            <div class="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
                <table class="min-w-full leading-normal">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold uppercase">Pelanggan</th>
                            <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold uppercase">Paket</th>
                            <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold uppercase">Jumlah</th>
                            <th class="px-5 py-3 border-b-2 text-left text-xs font-semibold uppercase">Siklus</th>
