            ...
            <div id="tab-info-create" class="py-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control col-span-2">
                        ...
                        <input type="text" name="name" placeholder="Nama Kampanye" value="{{ old('name') }}" class="input input-bordered w-full" required />
                    </div>
                    <div class="form-control">
                        <label class="label"><span class="label-text">Channel</span></label>
                        <input type="text" name="channel" placeholder="e.g., Google Ads" value="{{ old('channel') }}" class="input input-bordered w-full" required />
                    </div>
                    <div class="form-control">
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="budget" placeholder="5000000" value="{{ old('budget') }}" class="input input-bordered w-full" required />
                    </div>
                    <div class="form-control">
                    ...
                    <div class="form-control col-span-2">
                        ...
                        <textarea name="description" class="textarea textarea-bordered w-full" placeholder="Deskripsi singkat kampanye">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
