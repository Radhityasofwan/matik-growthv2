            ...
            <table class="table w-full">
                ...
                <tbody>
                    ...
                    <tr class="hover">
                        ...
                        <td>Rp {{ number_format($campaign->budget, 0, ',', '.') }}</td>
...
{{-- SINKRONISASI: Menghapus modal-backdrop dan menggunakan komponen form DaisyUI --}}
        ...
        <form action="{{ route('campaigns.store') }}" method="POST">
            ...
            <div id="tab-info-create" class="py-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-control"><label class="label"><span class="label-text">Status</span></label><select name="status" class="select select-bordered w-full" required><option value="planned">Planned</option><option value="active">Active</option><option value="completed">Completed</option><option value="paused">Paused</option></select></div>
                    ...
                    <div class="form-control"><label class="label"><span class="label-text">Owner</span></label><select name="owner_id" class="select select-bordered w-full" required>@foreach($users as $user)<option value="{{ $user->id }}">{{ $user->name }}</option>@endforeach</select></div>
            ...
            <div id="tab-metrics-create" class="py-4 hidden">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control"><label class="label"><span class="label-text">Total Spent (Rp)</span></label><input type="number" step="any" name="total_spent" placeholder="0" value="{{ old('total_spent', 0) }}" class="input input-bordered w-full" /></div>
                    <div class="form-control"><label class="label"><span class="label-text">Revenue (Rp)</span></label><input type="number" step="any" name="revenue" placeholder="0" value="{{ old('revenue', 0) }}" class="input input-bordered w-full" /></div>
                    <div class="form-control"><label class="label"><span class="label-text">Impressions</span></label><input type="number" name="impressions" placeholder="0" value="{{ old('impressions', 0) }}" class="input input-bordered w-full" /></div>
                    <div class="form-control"><label class="label"><span class="label-text">Link Clicks</span></label><input type="number" name="link_clicks" placeholder="0" value="{{ old('link_clicks', 0) }}" class="input input-bordered w-full" /></div>
                    <div class="form-control"><label class="label"><span class="label-text">Hasil (Konversi)</span></label><input type="number" name="results" placeholder="0" value="{{ old('results', 0) }}" class="input input-bordered w-full" /></div>
                </div>
            </div>
        ...
        <form action="{{ route('campaigns.update', $campaign) }}" method="POST">
            ...
            <div id="tab-info-edit-{{ $campaign->id }}" class="py-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="form-control"><label class="label"><span class="label-text">Status</span></label><select name="status" class="select select-bordered w-full" required><option value="planned" @selected(old('status', $campaign->status) == 'planned')>Planned</option><option value="active" @selected(old('status', $campaign->status) == 'active')>Active</option><option value="completed" @selected(old('status', $campaign->status) == 'completed')>Completed</option><option value="paused" @selected(old('status', $campaign->status) == 'paused')>Paused</option></select></div>
                    ...
                    <div class="form-control"><label class="label"><span class="label-text">Owner</span></label><select name="owner_id" class="select select-bordered w-full" required>@foreach($users as $user)<option value="{{ $user->id }}" @selected(old('owner_id', $campaign->owner_id) == $user->id)>{{ $user->name }}</option>@endforeach</select></div>
                    <div class="form-control"><label class="label"><span class="label-text">Tanggal Mulai</span></label><input type="date" name="start_date" value="{{ old('start_date', $campaign->start_date->format('Y-m-d')) }}" class="input input-bordered w-full" required /></div>
                    <div class="form-control"><label class="label"><span class="label-text">Tanggal Selesai</span></label><input type="date" name="end_date" value="{{ old('end_date', $campaign->end_date->format('Y-m-d')) }}" class="input input-bordered w-full" required /></div>
