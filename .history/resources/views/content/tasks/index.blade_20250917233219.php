        ...
        <div class="card bg-base-200/50" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
            <div class="card-body p-4">
                ...
                <div id="{{ $status }}" class="min-h-[60vh] space-y-4 kanban-column pt-4" data-status="{{ $status }}">
                    ...
                    @endphp
                    <div id="task-{{ $task->id }}" class="card bg-base-100 shadow-md cursor-grab active:cursor-grabbing transition-all duration-300 hover:shadow-lg {{ $colorClass }}">
                        <div class="card-body p-4">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <div class="dropdown dropdown-end">
                                        ...
                                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-48 z-10 border border-base-300/50">
                                            <li><a onclick="window.TaskBoard.openEditModal({{ $task->id }})">Edit Tugas</a></li>
                                            <div class="divider my-1"></div>
                                            <li><a onclick="window.TaskBoard.promptMoveStatus({{ $task->id }}, 'open')">Pindah ke To Do</a></li>
                                            <li><a onclick="window.TaskBoard.promptMoveStatus({{ $task->id }}, 'in_progress')">Pindah ke In Progress</a></li>
                                            <li><a onclick="window.TaskBoard.promptMoveStatus({{ $task->id }}, 'review')">Pindah ke Review</a></li>
                                            <li><a onclick="window.TaskBoard.promptMoveStatus({{ $task->id }}, 'done')">Pindah ke Done</a></li>
                                            <div class="divider my-1"></div>
                                            <li>
...
{{-- Modal Buat Tugas (DaisyUI <dialog>) --}}
...
{{-- Modal Edit Tugas (DaisyUI <dialog>) --}}
...
@push('scripts')
    {{-- SortableJS via CDN (dipakai oleh TaskBoard di app.js) --}}
    <script src="https://cdn.jsdelivr.net/npm/sortablejs@1.15.3/Sortable.min.js" integrity="sha256-+Y2l1ZmcZ+1M2Kc9d0uR9sL2oW2i9i4S2y7P3g4e3RY=" crossorigin="anonymous"></script>
@endpush
