                    ...
                    <div class="flex items-center gap-1">
                      ...
                      <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-48 z-10 border border-base-300/50">
                          ...
                          <li><a onclick="moveStatus({{ $task->id }}, 'open')">Pindah ke To Do</a></li>
                          <li><a onclick="moveStatus({{ $task->id }}, 'in_progress')">Pindah ke In Progress</a></li>
                          <li><a onclick="moveStatus({{ $task->id }}, 'review')">Pindah ke Review</a></li>
                          <li><a onclick="moveStatus({{ $task->id }}, 'done')">Pindah ke Done</a></li>
                          <div class="divider my-1"></div>
                          <li>
...
<dialog id="edit_task_modal" class="modal">
  <div class="modal-box w-11/12 max-w-2xl">
    ...
    <form id="edit_task_form" action="" method="POST" class="mt-4 space-y-4">
      ...
      {{-- Opsi kirim WA untuk update --}}
      <div class="form-control">
        <label class="label cursor-pointer justify-start gap-3">
          <input type="checkbox" class="checkbox checkbox-primary" name="notify_wa" value="1">
          <span class="label-text">Kirim notifikasi WhatsApp untuk perubahan ini</span>
        </label>
      </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Drag & Drop: WA otomatis → tidak ada konfirmasi
  ...
  // Pindah status via menu dropdown
  window.moveStatus = function(taskId, newStatus) {
  ...
  // Submit edit via AJAX (fallback reload jika bukan JSON)
