...
<div class="container mx-auto px-3 sm:px-4 lg:px-6 py-5 lg:py-8 board-surface">
  ...
  <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-6 mb-6 lg:mb-8">
    ...
    <button type="button" class="btn btn-primary shadow"
      ...
      <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" class="h-4 w-4 mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="tooltip" data-tip="{{ $task->assignee->name }}">
                          <div class="avatar">
                            <div class="w-8 rounded-full ring ring-base-100">
                                ...
                                @else
                                    <img src="[https://ui-avatars.com/api/?name=](https://ui-avatars.com/api/?name=){{ urlencode($task->assignee->name) }}&background=random&color=fff" alt="Avatar of {{ $task->assignee->name }}" />
                                @endif
                            </div>
                          </div>
                        </div>
  ...
  <div class="modal-box w-11/12 max-w-2xl">
    ...
    <form action="{{ route('tasks.store') }}" method="POST" class="mt-4 space-y-4" id="create_form">
      ...
      <div class="form-control">
        ...
        <input type="url" name="link" class="input input-bordered w-full" placeholder="[https://example.com](https://example.com)" />
      </div>
