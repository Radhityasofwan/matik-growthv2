                    ...
                    <div class="flex justify-between items-start gap-2 pt-2">
                        ...
                        <div class="dropdown dropdown-end">
                            ...
                            <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-20 border border-base-300/50">
                                <li><a onclick="editIcon({{ $task->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 9.172a4 4 0 10-5.656 5.656" /></svg>
                                    Edit icon
                                </a></li>
                                <li><a onclick="openEditModal({{ $task->id }})">
                                ...
                                <li><a onclick="duplicateTask({{ $task->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                                    Duplicate
                                </a></li>
                                <div class="divider my-1"></div>
                                <li><a onclick="openCommentModal({{ $task->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
                                    Comment
                                </a></li>
                                <div class="divider my-1"></div>
                                <li><a onclick="togglePin({{ $task->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 5v14l7-3 7 3V5l-7 3-7-3z" /></svg>
                                    {{$task->is_pinned ? 'Unpin Task' : 'Pin Task'}}
                                </a></li>
                                <div class="divider my-1"></div>
                                <li><a onclick="deleteTask({{ $task->id }})" class="text-error">
...
<dialog id="comment_modal" class="modal">
  <div class="modal-box w-11/12 max-w-lg">
    <form method="dialog"><button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button></form>
    <h3 class="font-bold text-lg text-base-content">Tambah Komentar</h3>
    <div class="mt-4 space-y-4">
      <div class="form-control">
        <label class="label"><span class="label-text">Komentar</span></label>
        <textarea id="comment_content" class="textarea textarea-bordered w-full" rows="4" placeholder="Tulis komentar..."></textarea>
      </div>
