@php
  ...
  $barCls  = [
    'primary'   => 'task-bar-primary',
    'secondary' => 'task-bar-secondary',
    'accent'    => 'task-bar-accent',
    'info'      => 'task-bar-info',
    'success'   => 'task-bar-success',
    'warning'   => 'task-bar-warning',
    'error'     => 'task-bar-error',
      ...
      <div class="flex items-center gap-1">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-48 z-10 border border-base-300/50">
            <li><a onclick="window.TaskView.openEditModal({{ $task->id }})">Edit Tugas</a></li>
            <div class="divider my-1"></div>
            <li><a onclick="window.TaskView.promptMoveStatus({{ $task->id }}, 'open')">Pindah ke To Do</a></li>
            <li><a onclick="window.TaskView.promptMoveStatus({{ $task->id }}, 'in_progress')">Pindah ke In Progress</a></li>
            <li><a onclick="window.TaskView.promptMoveStatus({{ $task->id }}, 'review')">Pindah ke Review</a></li>
            <li><a onclick="window.TaskView.promptMoveStatus({{ $task->id }}, 'done')">Pindah ke Done</a></li>
            <div class="divider my-1"></div>
            <li>
