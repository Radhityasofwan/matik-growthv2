...
<div class="container mx-auto py-6">
    ...
    {{-- SINKRONISASI: Merombak total papan Kanban dengan komponen DaisyUI --}}
...
{{-- SINKRONISASI: Menambahkan input link dan opsi warna --}}
@php
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.promptMoveStatus = function(taskId, newStatus) {
        ...
        // Pindahkan elemen secara visual terlebih dahulu
...
async function openEditModal(taskId) {
    try {
        ...
        // FITUR BARU: Mengisi data link dan warna
        ...
        if(!colorFound) colorOptions[0].checked = true; // Default to first option if no color is set
