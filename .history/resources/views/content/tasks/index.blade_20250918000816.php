...
@section('content')
{{-- ===== CSS khusus halaman ini (langsung di view) ===== --}}
<style>
  .kanban-wrap{
    background-image:
...
<div class="container mx-auto py-6 kanban-wrap">
        ...
        <div class="card-body p-4">
          ...
          <div id="{{ $status }}" class="kanban-column pt-4 space-y-4" data-status="{{ $status }}">
            @foreach ($tasks[$status] as $task)
              {{-- Pakai partial jika ada; kalau tidak, render fallback inline agar kartu tetap tampil --}}
