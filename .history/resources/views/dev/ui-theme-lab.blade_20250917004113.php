...
<div class="rounded-2xl p-6 bg-gradient-to-r from-brand-500 via-highlight-pink to-highlight-cyan text-white shadow-lg">
  <h1 class="text-4xl font-extrabold">UI/UX Theme Lab</h1>
  <p class="mt-1 opacity-90">Softblue, Light, Dark — modern, fresh & interactive design system.</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
  <div class="card bg-base-200 hover:scale-105 transition-transform duration-300">
    <div class="card-body text-center">
      <h3 class="card-title">Micro Interaction</h3>
      <p>Hover aku biar kelihatan lebih hidup.</p>
    </div>
  </div>
  <div class="card bg-base-200 hover:bg-gradient-to-r hover:from-brand-400 hover:to-brand-600 text-neutral-content transition-all duration-500">
    <div class="card-body text-center">
      ...
      <p>Catchy, modern, dan responsive.</p>
    </div>
  </div>
</div>
