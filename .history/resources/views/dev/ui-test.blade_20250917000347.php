...
@section('title', 'UI/UX System Lab')

@section('content')
{{-- SATU WRAPPER UNTUK THEME SWITCH + INTERAKSI --}}
<section x-data="{
        theme: 'softblue',
        toast: { show: false, msg: '' },
        openDrawer: false,
        notify(msg) { this.toast.msg = msg; this.toast.show = true; setTimeout(()=> this.toast.show=false, 2000) }
    }"
    :data-theme="theme"
    class="space-y-8">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
            <h1 class="text-3xl font-bold text-neutral">UI/UX System Lab</h1>
            <p class="mt-1 text-neutral/60">
                Halaman referensi & simulasi pengembangan antarmuka (DaisyUI + Tailwind + Alpine + AOS + ApexCharts).
            </p>
        </div>

        <div class="flex items-center gap-2">
            <!-- Theme switcher (softblue/dark) -->
            <div class="dropdown dropdown-end">
                <label tabindex="0" class="btn btn-outline">Theme</label>
                <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-44 p-2 shadow">
                    <li><button @click="theme='softblue'">softblue</button></li>
                    <li><button @click="theme='dark'">dark</button></li>
                    <li><button @click="theme='light'">light</button></li>
                </ul>
            </div>
            <!-- Quick CTA -->
            <button class="btn btn-primary" @click="notify('Primary action clicked')">Primary CTA</button>
        </div>
    </div>
    ...
    <div class="card bg-base-100 shadow-sm border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
            <h2 class="card-title">Color Palette & Semantics (tema: <span class="lowercase" x-text="theme"></span>)</h2>
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="rounded-xl p-4 bg-primary text-primary-content border border-primary">
                    ...
                    <div class="text-sm opacity-80">Kontras untuk tombol/link utama.</div>
                </div>
    ...
    <div class="card bg-base-100 shadow-sm border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
            <h2 class="card-title">Typography Showcase</h2>
            <article class="prose max-w-none mt-4">
                <h1>Heading 1</h1>
                <h2>Heading 2</h2>
                <h3>Heading 3</h3>
                <p>
                    Body text with <strong>bold</strong>, <em>italic</em>, <a href="#">link</a>,
                    <code>inline code</code>, dan <kbd>kbd</kbd>.
                </p>
                <pre><code>const hello = 'world'</code></pre>
                <ul><li>List item</li><li>Another item</li></ul>
                <blockquote>Quote example using prose styles.</blockquote>
            </article>
        </div>
    </div>

    {{-- FORM ELEMENTS (plugin @tailwindcss/forms) --}}
    <div class="card bg-base-100 shadow-sm border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div class="form-control">
                    ...
                    <label class="label cursor-pointer"><span class="label-text">Toggle</span>
                        <input type="checkbox" class="toggle toggle-primary" checked>
                    </label>
                </div>
                <div class="form-control md:col-span-2">
                    <label class="label"><span class="label-text">Textarea</span></label>
                    <textarea class="textarea textarea-bordered" rows="4" placeholder="Your message"></textarea>
                </div>
                <div class="md:col-span-2 flex flex-wrap items-center gap-4">
                    <input type="range" min="0" max="100" value="30" class="range range-primary w-64">
                    <div class="rating">
                        <input type="radio" name="rating-1" class="mask mask-star-2 bg-warning" />
    ...
    <div class="card bg-base-100 shadow-sm border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
            <h2 class="card-title">Buttons, Badges, Alerts</h2>
    ...
    {{-- LAYOUT: TABS / COLLAPSE / DROPDOWN / TOOLTIP --}}
    <div class="card bg-base-100 shadow-sm border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
            <h2 class="card-title">Layout & Interactions</h2>
            ...
            <div class="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="collapse bg-base-200">
                    <input type="checkbox">
                    <div class="collapse-title text-lg font-medium">Accordion / Collapse</div>
                    <div class="collapse-content">
                        <p>Konten ini harus muncul/tersembunyi.</p>
                    </div>
                </div>
    ...
    {{-- DATA: TABLE RESPONSIF + STATS CARD --}}
    <div class="card bg-base-100 shadow-sm border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
    ...
    <div class="card bg-base-100 shadow-sm border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
            ...
            <div class="flex flex-wrap items-center gap-2 mt-3">
                <button class="btn btn-primary" onclick="document.getElementById('demo_modal').showModal()">Open Modal</button>
                <button class="btn btn-secondary" @click="openDrawer = true">Open Drawer</button>
                <button class="btn btn-accent" @click="notify('Saved successfully')">Show Toast</button>
            </div>
            ...
            <div class="drawer" :class="openDrawer ? 'drawer-open' : ''">
                <input type="checkbox" class="drawer-toggle" :checked="openDrawer" />
                <div class="drawer-content"></div>
                <div class="drawer-side">
                    <label @click="openDrawer=false" class="drawer-overlay"></label>
    ...
    {{-- CHART + SKELETON (ApexCharts; bebas CLS) --}}
    <div class="card bg-base-100 shadow-sm border border-base-300/50" data-aos="fade-up">
        <div class="card-body">
