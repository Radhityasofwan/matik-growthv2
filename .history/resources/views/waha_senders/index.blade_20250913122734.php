...
<div class="container mx-auto px-4" x-data="senderPage()" x-init="load()">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-2">
            ...
            <button type="button" class="btn btn-ghost btn-sm" :class="{'loading': loading}" @click="load()" :disabled="loading">Muat Ulang</button>
    ...
    <div class="card">
        <div class="card-body overflow-x-auto">
                    ...
                    <template x-for="s in paged" :key="s.id">
                        <tr>
                            ...
                            <td class="text-right space-x-2">
                                <button type="button" class="btn btn-sm" @click="openEdit(s)">Edit</button>
            ...
            <div class="mt-4 flex items-center justify-between" x-show="pages > 1">
                ...
                <div class="join">
                    <button type="button" class="btn btn-sm join-item" @click="prev()" :disabled="page===1">«</button>
                    <button type="button" class="btn btn-sm join-item" disabled x-text="page + ' / ' + pages"></button>
                    <button type="button" class="btn btn-sm join-item" @click="next()" :disabled="page===pages">»</button>
                </div>
            </div>
        </div>
    </div>
...
{{-- Alpine helpers --}}
<script>
// Pastikan komponen tersedia di scope global saat Alpine inisialisasi
