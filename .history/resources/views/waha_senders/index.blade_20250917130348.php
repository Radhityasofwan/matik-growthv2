...
<div class="container mx-auto py-6">
    ...
    @if ($errors->any())
        <div class="alert alert-error shadow-lg mb-6" data-aos="fade-down">
            <div>
                <svg xmlns="http://www.w.w3.org/2000/svg" class="stroke-current flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" data-aos="fade-down">
        ...
        <a href="#create_sender_modal" class="btn btn-primary">
            <svg xmlns="http://www.w.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
            Tambah Sender
        </a>
    </div>
                        ...
                        <tr class="hover">
                            ...
                            <td class="text-right">
                                <div class="flex gap-2 justify-end">
                                    <a href="#scan_sender_{{ $s->id }}" class="btn btn-primary btn-sm" onclick="startScan({{ $s->id }}, @js($s->name))">
                                        Scan / Connect
                                    </a>
                                    <div class="dropdown dropdown-end">
                                        ...
                                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-10 border border-base-300/50">
                                            <li><a href="#edit_sender_{{ $s->id }}">Edit</a></li>
                                            <li>
