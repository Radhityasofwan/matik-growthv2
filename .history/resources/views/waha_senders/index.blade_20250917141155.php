                        ...
                        <tr class="hover">
                            ...
                            <td class="text-right relative z-10">
                                <div class="flex gap-2 justify-end">
                                    ...
                                    {{-- Arah aman di kanan; boleh ke kiri saat layar lebar --}}
                                    <div class="dropdown dropdown-end md:dropdown-left">
                                        ...
                                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-[200] border border-base-300/50 max-h-[70vh] overflow-auto">
