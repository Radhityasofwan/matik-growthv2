...
<div class="container mx-auto py-6">
    ...
    @else
        ...
        <div class="card bg-base-100 shadow-lg border border-base-300/50 mt-8 !overflow-visible" data-aos="fade-up">
            {{-- IZINKAN overflow vertikal supaya dropdown tidak terpotong --}}
                        ...
                        <tr class="hover">
                            ...
                            <td class="text-right relative z-10">
                                <div class="flex gap-2 justify-end">
                                    ...
                                    {{-- Arah aman di tepi kanan; ke kiri saat layar lebar --}}
                                    <div class="dropdown dropdown-end md:dropdown-left">
                                        <label tabindex="0" class="btn btn-ghost btn-sm">Opsi</label>
                                        {{-- Z-index tinggi + scroll internal agar tidak kepotong viewport --}}
                                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-[9999] border border-base-300/50 max-h-[70vh] overflow-auto">
                                            <li><button type="button" onclick="document.getElementById('edit_sender_{{ $s->id }}').showModal()">Edit</button></li>
                                            <li>
                                                <a href="#" onclick="event.preventDefault(); document.getElementById('form-default-{{ $s->id }}').submit();" class="{{ $s->is_default ? 'pointer-events-none opacity-50' : '' }}">Jadikan Default</a>
                                            </li>
