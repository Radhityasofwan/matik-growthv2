...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    | - Kelola Sender ada di modal pada halaman Broadcast (AJAX ke rute waha-senders)
    |--------------------------------------------------------------------------
    */
    ...
    // (Dihapus) WA Logs & Manual Broadcast tidak dipakai untuk menyederhanakan menu
    ...
    */
    ...
    | - index: HTML tabel (kalau biasa) atau JSON (Accept: application/json)
    | - dipakai oleh modal "Kelola Sender" & tombol "Refresh Sender"
    |--------------------------------------------------------------------------
    */
