...
Route::middleware('auth')->group(function () {
    ...
    // Rute untuk aksi dropdown baru
    Route::post('tasks/{task}/toggle-pin', [TaskController::class, 'togglePin'])->name('tasks.togglePin');
    Route::post('tasks/{task}/duplicate', [TaskController::class, 'duplicate'])->name('tasks.duplicate');
    Route::get('tasks/{task}/copy-link', [TaskController::class, 'copyLink'])->name('tasks.copyLink');
