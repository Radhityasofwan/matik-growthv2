...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    // QR Code (start, status, logout) — aktifkan bila controllernya sudah ada
    Route::post('waha-senders/{wahaSender}/qr-start',  [\App\Http\Controllers\WahaSenderController::class, 'qrStart'])->name('waha-senders.qr.start');
    Route::get ('waha-senders/{wahaSender}/qr-status', [\App\Http\Controllers\WahaSenderController::class, 'qrStatus'])->name('waha-senders.qr.status');
    Route::post('waha-senders/{wahaSender}/qr-logout', [\App\Http\Controllers\WahaSenderController::class, 'qrLogout'])->name('waha-senders.qr.logout');
