...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    // Subscriptions: hanya index/update/destroy (tanpa show/create/store/edit)
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Notifications (halaman + feed + mark read/all)
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    Route::resource('owner-follow-up-rules', \App\Http\Controllers\OwnerFollowUpRuleController::class)
    ->only(['index','store','update','destroy']);
});
