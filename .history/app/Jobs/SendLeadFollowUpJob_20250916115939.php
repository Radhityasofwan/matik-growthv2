...
class SendLeadFollowUpJob implements ShouldQueue
{
    ...
    /**
     * Kirim via WAHA dengan dependency injection method:
     * container akan mengisi parameter bertipe class (WahaService, dst).
     */
    protected function sendViaWaha(int $senderId, string $recipient, string $message): array
    {
        ...
        // PENTING: gunakan container call agar parameter seperti WahaService diinject otomatis
