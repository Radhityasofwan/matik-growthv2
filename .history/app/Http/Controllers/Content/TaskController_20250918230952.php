...
class TaskController extends Controller
{
    public function index(Request $request)
    {
        ...
        $tasks = [
            ...
            'review'      => $tasksCollection->get('review', collect()), // preview column
    ...
    public function store(TaskRequest $request)
    {
        ...
        // sinkron owner melalui pivot
        $ownerIds = $request->input('owner_ids', []);
        $task->owners()->sync($ownerIds);

        // Notifikasi in-app untuk tiap owner
        ...
        // WA sekali, job akan mendistribusikan ke semua PIC/owner/creator
    ...
    public function edit(Task $task)
    {
        ...
        return response()->json([
            'task' => [
                ...
                'owner_ids'   => $task->owners->pluck('id')->values(), // konsisten untuk dropdown multi-user
    ...
    public function updateStatus(Request $request, Task $task)
    {
        ...
        return response()->json(['success'=>true,'message'=>'Status tugas diperbarui.','status'=>$task->status]);
    }
