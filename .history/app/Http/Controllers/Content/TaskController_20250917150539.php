...
class TaskController extends Controller
{
    public function index(Request $request)
    {
        ...
        // FIXED: Memastikan semua kolom status, termasuk 'review', selalu ada di dalam array
        $tasks = [
    ...
    {
        // Menambahkan 'link' dan 'color' ke data yang divalidasi
    ...
    {
        // Menambahkan 'link' dan 'color' ke response JSON
    ...
    public function update(TaskRequest $request, Task $task)
    {
        ...
        // Menambahkan 'link' dan 'color' ke data yang akan diupdate
        $data = $request->validated() + [
            'link'  => $request->input('link'),
            'color' => $request->input('color'),
        ];
