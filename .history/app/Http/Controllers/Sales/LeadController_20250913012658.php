...
use App\Models\WahaSender; // ✅ penting: import model yang benar
...
class LeadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // ✅ gunakan model WahaSender dari namespace App\Models
        $wahaSenders = WahaSender::where('is_active', true)
            ->orderBy('name')
            ->get();
