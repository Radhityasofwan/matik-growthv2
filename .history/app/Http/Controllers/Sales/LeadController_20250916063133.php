...
class LeadController extends Controller
{
    ...
    /* =========================================================
     |               WHATSAPP: SINGLE & BULK SEND
     * ========================================================= */

    /** Kirim pesan WA ke satu lead (AJAX-friendly JSON) */
    public function waSend(Request $request, Lead $lead)
    {
        ...
        activity()
            ...
            ->withProperties([
                ...
                'result'    => $resp,
            ])->log($resp['success'] ? 'WA terkirim' : 'WA gagal');
        ...
        return response()->json([
            ...
            'path'        => $resp['path'] ?? null,
            'error'       => $resp['success'] ? null : ($resp['error'] ?? 'Gagal mengirim.'),
        ], ($resp['success'] ?? false) ? 200 : 502);
    }

    /** Kirim pesan WA ke banyak lead (IDs) */
    ...
    /**
     * Pilih sender:
     * 1) sender_id eksplisit (jika aktif),
     * 2) default (is_default = true & aktif),
     * 3) aktif pertama.
     */
