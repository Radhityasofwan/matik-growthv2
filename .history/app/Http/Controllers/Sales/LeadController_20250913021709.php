...
use Illuminate\Support\Facades\Schema; // cek kolom aman
...
class LeadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Stabil: bila kolom "name" belum ada (DB lama), fallback orderBy id
    ...
    public function import(Request $request)
    {
        ...
        try {
            foreach (array_slice($rows, 1) as $row) {
                ...
                // Fallback name: store_name -> ownerName -> before @
