...
class FollowUpProbe extends Command
{
    ...
    public function handle(): int
    {
        ...
        /* ===== 1b) Siapkan SENDER (isi seluruh kolom session yg ada) ===== */
        $sessionVal  = 'sender-probe';
        $senderAttrs = [
            'name'       => 'Sender Probe',
            'number'     => '6285166321841',
            'is_active'  => true,
            'is_default' => true,
        ];
        ...
        // Cari berdasarkan kolom session yang tersedia agar unik & tidak bentrok
        ...
        if (Schema::hasColumn('waha_senders', 'session_name')) {
            ...
            // fallback terakhir
            $sender = $senderQuery->firstOrNew(['name' => 'Sender Probe']);
        }
