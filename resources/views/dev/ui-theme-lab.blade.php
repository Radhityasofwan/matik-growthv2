...
<div
  x-data="{
    // FIXED: Menambahkan semua tema built-in DaisyUI + tema kustom Anda
...
>
  ...
  <div class="text-center" data-aos="fade-down">
    ...
    {{-- FIXED: Mengubah switcher menjadi dropdown untuk mengakomodasi banyak tema --}}
    <div class="mt-6 max-w-xs mx-auto">
        <div class="form-control">
            <label class="label"><span class="label-text">Pilih Tema Aktif</span></label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            ...
            <div class="space-y-4">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 border border-base-300/50 z-10">
                        <li><a>Item 1</a></li>
                        <li><a>Item 2</a></li>
                    </ul>
                </div>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('apexChartDemo', () => ({
        ...
        renderChart() {
            ...
            const isDark = ['dark', 'synthwave', 'halloween', 'forest', 'black', 'luxury', 'dracula', 'business', 'night', 'coffee'].includes(document.documentElement.getAttribute('data-theme'));
